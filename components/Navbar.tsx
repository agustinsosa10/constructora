    ...
    >
      <div className="max-w-[1440px] mx-auto px-6 h-18 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8 text-white text-sm font-semibold tracking-wide">
          <Link href="/#hero" className={`transition-colors ${esHome && activeSection === "hero" ? "text-[#C41230]" : "hover:text-[#C41230]"}`}>
            Inicio
          </Link>
          <Link href="/#nosotros" className={`transition-colors ${esHome && activeSection === "nosotros" ? "text-[#C41230]" : "hover:text-[#C41230]"}`}>
            Nosotros
          </Link>
          <Link href={enProyectos ? "/proyectos" : "/#proyectos"} className={`transition-colors ${esHome && activeSection === "proyectos" ? "text-[#C41230]" : "hover:text-[#C41230]"}`}>
            Proyectos
          </Link>
          <Link
            href="/#contacto"
            className={`text-white px-5 py-2 text-xs font-bold tracking-widest uppercase transition-colors ${esHome && activeSection === "contacto" ? "bg-red-800" : "bg-[#C41230] hover:bg-red-800"}`}
          >
            Consultanos
          </Link>
        </div>
      ...
      >
        <div className="flex flex-col px-6 py-4 gap-1 text-white text-sm font-semibold tracking-wide">
          <Link href="/#hero" onClick={() => setMenuOpen(false)} className="py-3 border-b border-white/10 hover:text-[#C41230] transition-colors">
            Inicio
          </Link>
          <Link href="/#nosotros" onClick={() => setMenuOpen(false)} className="py-3 border-b border-white/10 hover:text-[#C41230] transition-colors">
            Nosotros
          </Link>
          <Link href={enProyectos ? "/proyectos" : "/#proyectos"} onClick={() => setMenuOpen(false)} className="py-3 border-b border-white/10 hover:text-[#C41230] transition-colors">
            Proyectos
          </Link>
          <Link
            href="/#contacto"
