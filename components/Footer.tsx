...
const LINKS_PROYECTOS = [
  ...
  { label: "Próximamente", href: "/proyectos?estado=Proximo+lanzamiento" },
  { label: "En desarrollo", href: "/proyectos?estado=En+construccion" },
  { label: "Entregados", href: "/proyectos?estado=Entregado" },
];
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <div className="flex gap-2 flex-wrap justify-center md:justify-start">
                <a
                  ...
                  className="w-8 h-8 border border-white/20 flex items-center justify-center text-white/50 hover:border-white/60 hover:text-white transition-colors"
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col items-center gap-2">
          <p className="text-white/30 text-xs text-center">
            © {new Date().getFullYear()} IES Desarrollos Inmobiliarios. Todos
            los derechos reservados.
          </p>
          <p className="text-white/20 text-xs text-center">
            Construido con ♥ por <span className="font-semibold">dagatek</span>
          </p>
        </div>
      </div>
    </footer>
