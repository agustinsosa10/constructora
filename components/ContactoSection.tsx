              ...
              {status === "sent" ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="relative flex items-center gap-3 my-2">
                    ...
                    <span className="text-xs text-[#595959] tracking-widest uppercase">o</span>
                    <div className="flex-1 h-px bg-[#e0e0e0]" />
                  </div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-3 w-full border border-[#25D366] text-[#1A1A1A] py-4 text-xs font-bold tracking-widest uppercase hover:bg-[#25D366] hover:text-white transition-colors"
                  >
