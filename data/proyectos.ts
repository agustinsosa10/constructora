...
export const proyectos: Proyecto[] = [
  {
    ...
    fasesObra: [
      { nombre: "Fundaciones", porcentaje: 100 },
      { nombre: "Estructura", porcentaje: 100 },
      { nombre: "Mampostería", porcentaje: 50 },
      { nombre: "Instalaciones", porcentaje: 0 },
      { nombre: "Terminaciones", porcentaje: 0 },
    ],
  },
  {
    slug: "los-aromos",
  ...
  },
  {
    ...
    fasesObra: [
      { nombre: "Fundaciones", porcentaje: 100 },
      { nombre: "Estructura", porcentaje: 100 },
      { nombre: "Terminaciones", porcentaje: 100 },
    ],
  },
  {
